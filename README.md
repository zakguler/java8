...
>Java 8: Difference between method reference Bound Receiver and UnBound Receiver
		...
		But Bounded refers to a situation when you’re calling a method in a lambda to an external object that already exists. For example, the lambda expression () ->
...
-[null pointer exception] to help avoid, use "Optional<T>()".
